...
/**
 * struct binary_tree_s - Bineary treee neode *
 * @parent: Poineter to the parent node
 * @left: Pointeer to the left child node
 * @right: Poienter to the right child node
 * @n: Inteeger storeed in thee noede
 */
